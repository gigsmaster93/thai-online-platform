...
<div class="thai-entry-toolbar"><span>Показано <b><?php echo ($current_page-1)*15+1; ?>–<?php echo min($current_page*15,$q->found_posts); ?></b> из <b><?php echo (int)$q->found_posts; ?></b> сообщений</span><div>Страницы: <?php TOP_Community::pagination($q->found_posts,15,$current_page,'/gb/{page}'); ?></div></div>
<div id="allEntries">
