...
$page=TOP_Community::page();$q=new WP_Query(['post_type'=>'thai_guestbook','post_status'=>'publish','posts_per_page'=>15,'paged'=>$page,'meta_key'=>'_thai_live_review','meta_value'=>1,'orderby'=>'date','order'=>'DESC']);
get_header(); ?>
...
<?php TOP_Community::pagination($q->found_posts,15,$page,'/gb/{page}'); ?>
<div id="allEntries">
