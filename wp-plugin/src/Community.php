...
class TOP_Community {
    public static function boot() {
        ...
        add_action('wp_enqueue_scripts', static function(){
            if(get_query_var('top_community') || is_page('contact')) wp_enqueue_style('thai-community',plugins_url('assets/community.css',TOP_PLUGIN_FILE),[], '4.4.43');
            if(get_query_var('top_community')==='photo') wp_enqueue_style('thai-photo-legacy',home_url('/_st/photo.css'),[], '525');
            if(get_query_var('top_community')==='forum') wp_enqueue_script('thai-community-forum',plugins_url('assets/community.js',TOP_PLUGIN_FILE),[], '4.4.43',true);
