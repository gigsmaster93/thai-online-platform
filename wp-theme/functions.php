...
define('THAI_ONLINE_THEME_VERSION', '4.4.5');
...
, 'index.php?top_module=shop_all&top_page=1', 'top');
    add_rewrite_rule('^shop/all/([0-9]+)/?
...
, 'index.php?top_module=shop_all&top_page=$matches[1]', 'top');
}, 20);
