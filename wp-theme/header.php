...
<link rel="icon" href="<?php echo esc_url(get_template_directory_uri() . '/favicon.png'); ?>" type="image/png" sizes="64x64">
<?php wp_head(); ?>
</head>
    ...
    <div class="width clearfix">
      ...
      <div class="clearfix right">
        ...
        <div id="top-head-manage" class="right clearfix">
          <div id="shop-header-currency"><a href="#" class="utml bl" aria-haspopup="true" aria-expanded="false"><span class="flaticon-customer-service top-text-icon"></span><span class="tht-up-text tohide">Язык</span></a><div class="drop-area" aria-hidden="true"><div class="drop-area-main"><div id="shop-currency"><div class="tac"><small>Выберите желаемый язык:</small></div><div id="newVals"><div id="curValue"><ul></ul></div><ul><li class="selected"><a href="<?php echo esc_url(home_url('/')); ?>"><div class="val">RU</div><div class="flag rub"></div></a></li><li><a href="https://thai-online.tours"><div class="val">EN</div><div class="flag usd"></div></a></li></ul></div></div></div></div></div>
          <div id="shop-header-profile"><a href="#" class="utml bl" aria-haspopup="true" aria-expanded="false"><span class="flaticon-avatar top-text-icon"></span><span class="tht-up-text tohide">Мой аккаунт</span></a><div class="drop-area" aria-hidden="true"><div class="drop-area-main"><ul class="account-links"><?php if (is_user_logged_in()): ?><li><a href="<?php echo esc_url(admin_url('profile.php')); ?>">Профиль</a></li><li><a href="<?php echo esc_url(wp_logout_url(home_url('/'))); ?>">Выход</a></li><?php else: ?><li><a href="<?php echo esc_url(wp_login_url()); ?>">Вход</a></li><?php if (get_option('users_can_register')): ?><li><a href="<?php echo esc_url(wp_registration_url()); ?>">Регистрация</a></li><?php endif; ?><?php endif; ?></ul></div></div></div>
        </div>
      </div>
