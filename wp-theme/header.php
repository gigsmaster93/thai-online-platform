...
<header class="header">
      ...
      <div class="clearfix right">
        ...
        <div id="top-head-manage" class="right clearfix">
          <div id="shop-header-currency">
            <a href="#" class="utml bl"><span class="fa fa-language top-text-icon"></span><span class="tht-up-text tohide">Язык</span></a>
            <div class="drop-area"><div class="drop-area-main"><div id="shop-currency"><div class="tac"><small>Выберите желаемый язык:</small></div><div id="newVals"><div id="curValue"><ul></ul></div><ul><li class="selected"><a href="<?php echo esc_url(home_url('/')); ?>"><div class="val">RU</div></a></li><li><a href="https://thai-online.tours"><div class="val">EN</div></a></li></ul></div></div></div></div>
          </div>
          <div id="shop-header-profile">
            <a href="#" class="utml bl"><span class="fa fa-user top-text-icon"></span><span class="tht-up-text tohide">Мой аккаунт</span></a>
  ...
  <div class="topButtons">
    <div class="width">
      <ul class="sn width">
        <li><a href="https://vk.com/thaibooking" rel="nofollow" target="_blank"><span class="fa thai-vk">VK</span></a></li>
        <li><a href="https://www.facebook.com/thaibookingportal/" rel="nofollow" target="_blank"><span class="fa fa-facebook"></span></a></li>
        <li><a href="https://www.instagram.com/thaionlineorg/" rel="nofollow" target="_blank"><span class="fa fa-instagram"></span></a></li>
        <li><a href="https://www.youtube.com/channel/UCDIGpPr7O6JXF9icDT0bTEA" rel="nofollow" target="_blank"><span class="fa fa-youtube-play"></span></a></li>
      </ul>
      <div class="clr"></div>
  ...
  <div class="videox"><div class="videoOl"></div></div>
  <div class="clr"></div>
  <?php endif; ?>
</header>
